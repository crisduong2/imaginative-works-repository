...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 px-6 bg-gray-50 dark:bg-gray-900/30">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-black/20 focus:border-black/30 transition-all"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-black/20 focus:border-black/30 transition-all resize-none"
              ...
              <motion.button
                ...
                className="w-full px-6 py-4 bg-black text-white rounded-lg font-medium text-sm tracking-wide hover:bg-black/90 transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center"
              >
                {isSubmitting ? (
                  <>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="sticky top-32 bg-white dark:bg-gray-800 rounded-xl p-8 shadow-soft">
              <h3 className="text-xl font-medium mb-6">Contact Information</h3>
              
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-12 h-12 bg-black/5 rounded-full flex items-center justify-center mr-4">
